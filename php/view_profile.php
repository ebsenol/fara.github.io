<?php
	...
	if ($clicked){
		...
		$res = mysqli_query($db, "Insert INTO follows Values ('$username' , '$smth' );");
		$id = mysqli_insert_id($db);	$id = mysqli_insert_id($db);
	}
	else{
		$res = mysqli_query($db, "DELETE FROM follows WHERE follower = '".$username."' AND following = '".$smth."';");
   ...
   <nav id="navbarmain"  class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class = "row">
                ...
                <div class="form-group">
					...
					<input onclick="change()" type="submit" name = "follow" value="Follow" id="Follow">
                ...
                <div class="form-group">
				<input onclick="window.location.href = 'message.php'"  type="button" value="Send Message" id="Send Message">
